...
project_id = 'airflowand-bigquery'
dataset_id = 'staging_dataset'
transformed_dataset_id = 'transformed_dataset'
reporting_dataset_id = 'reporting_dataset'
source_table = f'{project_id}.{dataset_id}.raw_global_data'  # Main table loaded from CSV
countries = ['USA', 'India', 'Germany', 'Japan', 'France', 'Italy', 'Canada']  # Country-specific tables to be created
